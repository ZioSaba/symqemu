...
qemu-doc - QEMU version 4.1.1 User Documentation
...
=item B<in|out.period-len=>I<usecs>
...
=item B<-virtfs local,path=>I<path>B<,mount_tag=>I<mount_tag> B<,security_model=>I<security_model>B<[,writeout=>I<writeout>B<][,readonly] [,fmode=>I<fmode>B<][,dmode=>I<dmode>B<]>
